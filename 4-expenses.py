...
# Проверяем на корректность ввода руб и коп
if 'руб' not in user_input1 and 'коп' not in user_input1:
    print("Некорректный ввод. Введите сумму в формате '100 руб 10 коп'.")
    exit()
